...
infile_reg_outline <- "/Volumes/Data/Ecuador_Project/region_outlines_ref_files/OR83M_state_outline.shp"  #input region outline defined by polygon: Oregon
...
ref_rast_name<-"/Volumes/Data/Ecuador_Project/region_outlines_ref_files/mean_day244_rescaled.rst"  #local raster name defining resolution, exent: oregon
...
infile_modis_grid<-"/Volumes/Data/Ecuador_Project/region_outlines_ref_files/modis_sinusoidal_grid_world.shp" #modis grid tiling system, global

out_suffix <-"12282013" #output suffix for the files that are masked for quality and for 

## Other specific parameters

MODIS_product <- "MOD13Q1.005"
