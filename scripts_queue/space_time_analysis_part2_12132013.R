...
arima_mod1 <- auto.arima(pix_val[1,1:153]) #fit a model for a pixel across time before
                                           #hurricane

p_arima<-predict(arima_mod,n.ahead=2) #predict using fitted model, two step ahead
...
dif_pred  <-  r_huric_w - r_t0_pred  #residuals
