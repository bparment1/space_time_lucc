...
function_spatial_regression_analyses <- "SPatial_analysis_spatial_reg_05082015_functions.R" #PARAM 1
...
out_suffix <-"NDVI_Katrina_05082015" #output suffix for the files and ouptu folder #PARAM 8
