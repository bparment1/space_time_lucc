...
Moore_extent_name <- "/Users/benoitparmentier/Dropbox/Data/Space_Time/Moore_EXTENT_1_sin.rst"
...
### apply to all ejido from the sample....
...
#### NOW do Moore area!! about 34,894 pixels
...
ttx<-lapply(pix_val,FUN=raster_ts_arima_predict,na.rm=T,arima_order=NULL,n_ahead=2)
