...
function_space_and_time_predictions <- "space_and_time_predictions_functions_05252018b.R"
...
args_table <- "/media/dan/Space_beats_time/Space_beats_time/Data/input_arguments_sbt_script_REACT_Dakar_NDVI_mod13_05252018b.csv"
