...
if(is.null(r_temp_red)){
  ## Change this later on to make it general: works for now...
  ## This should be produce when the predicitons are done
  
  in_dir1 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_1_NDVI_Rita_11062017"
  in_dir2 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_2_NDVI_Rita_11062017"
  ...
  out_file1 <- file.path(in_dir1,"raster_temp_files_list_tile_1.txt")
  write.table(r_temp_pred1,out_file1)
  out_file1 <- file.path(in_dir2,"raster_temp_files_list_tile_2.txt")
  write.table(r_temp_pred2,out_file2)
  
}

if(is.null(r_spat_pred)){
  ## Change this later on to make it general: works for now...
  
  in_dir1 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_1_NDVI_Rita_11062017"
  in_dir2 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_2_NDVI_Rita_11062017"
  
  r_spat_pred1 <- list.files(path=in_dir1,
                                           pattern="r_spat_.*._tile_1_NDVI_Rita_11062017.tif",
                                           full.names=T)
  r_spat_pred2 <- list.files(path=in_dir2,
                                           pattern="r_spat_pred_mle_eigen_no_previous_step_.*._tile_1_NDVI_Rita_11062017.tif",
                                           full.names=T)
  #r_spat_pred <- list.files(path=in_dir,
  #                          pattern="r_spat_pred_mle_eigen_no_previous_step_.*.tif",
  ...
  out_file1 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_1_NDVI_Rita_11062017/raster_spat_files_list_tile_1.txt"
  out_file2 <- "/home/bparmentier/Google Drive/Space_beats_time/outputs/output_tile_2_NDVI_Rita_11062017/raster_spat_files_list_tile_2.txt"
  
  write.table(r_spat_pred1,out_file1)
  write.table(r_spat_pred2,out_file2)
  #
}
...
if(!is.null(mosaic_dir)){
  ...
  out_dir_s <- file.path(out_dir,mosaic_dir)
  ...
  out_rastnames_var <- out_rastnames_temp
